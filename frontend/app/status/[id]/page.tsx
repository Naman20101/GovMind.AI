...
import { type PermitResponse } from '@/lib/api'
...
export default function StatusPage() {
  ...
  const load = async () => {
    ...
    setError('')
    try {
      const res = await fetch(`/api/permits/${safeId}`, { cache: 'no-store' })
      if (res.ok) {
      ...
      <div className="card animate-fade-up">
        ...
        <div className="mt-4 pt-4 border-t border-gray-100 flex items-center gap-4 text-xs text-gray-400">
          <span className="flex items-center gap-1">
            ...
            Submitted {new Date(permit.submitted_at).toLocaleDateString('en-US', {
          ...
          {permit.ai_confidence != null && (
            <div className="mb-4">
              ...
              <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                <div className="h-full bg-[#1B4F72] rounded-full transition-all duration-700"
